    ...
    public appHeaderItems = [
        {
            ...
            subNav: [
                ...
                { label: "Book Stats", href: "/home/dashboard/book" }
            ]
        },
        { label: "Orders", href: "/home/orders", subNav: [] },
        { label: "Books", href: "/home/books", subNav: [] },
    ...
    constructor(
        ...
        router.events
            ...
            .subscribe(data => {
                ...
                this.selectedHeaderItemIndex = data[0]
                    ? data[0].selectedHeaderItemIndex
                    : -1;
                this.selectedSubNavItemIndex = data[0]
                    ? data[0].selectedSubNavItemIndex
                    : -1;
            });
