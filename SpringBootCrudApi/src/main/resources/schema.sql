DROP SCHEMA IF EXISTS A_TEAM;

CREATE SCHEMA A_TEAM;
USE A_TEAM;
...
/* Foreign Key: orders */
ALTER TABLE orders
  ADD CONSTRAINT fk_orders__customers FOREIGN KEY (customer_id) REFERENCES customers (id) ON DELETE CASCADE ;
ALTER TABLE orders
  ADD CONSTRAINT fk_orders__employees FOREIGN KEY (employee_id) REFERENCES employees (id) ON DELETE CASCADE ;
/* Foreign Key:  order_items */
ALTER TABLE order_items
  ADD CONSTRAINT fk_order_items__orders FOREIGN KEY (order_id) REFERENCES orders (id) ON DELETE CASCADE ;
ALTER TABLE order_items
  ADD CONSTRAINT fk_order_items__books FOREIGN KEY (book_id) REFERENCES books (id) ON DELETE CASCADE ;
